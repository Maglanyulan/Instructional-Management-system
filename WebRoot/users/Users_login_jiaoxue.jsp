			...
			<div id="mainPanel">
				<div id="left">
					 <div id="menu_container">
						<ul id="menu_items">
							<li class="menu_item" onmouseout="this.style.backgroundColor='';this.style.fontWeight='normal'" onmouseover="this.style.backgroundColor='#77D1F6';this.style.borderRadius='2px 0 0 2px'">教学公告</a></li>
...
 						<s:iterator value="#session.JXtitle" var="jxtitle">
						
							<%-- <td><s:property value="#jxtitle.title"/></td> --%>
							<ul>
								<li>  
									<%-- <s:a href='MainPage_getJXContent.action?id=<s:property value="%{#jxtitle.TAnnoId}"/>'> --%>  
										<s:a href='MainPage_getJXContent.action?id=%{#jxtitle.TAnnoId}'>
										<s:property value="#jxtitle.title"/>  
									</s:a>
								</li>
							</ul>
