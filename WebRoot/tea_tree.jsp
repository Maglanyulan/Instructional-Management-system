...
var treeMenu = [
	{ level:1, name:"个人信息"},
	{ level:2, name:"基本信息", ico:"${ pageContext.request.contextPath}/images/icon_default.gif",link:"Teacher_query.action?tid=${loginUserName}"},
	{ level:1, name:"课程管理"},
	{ level:2, name:"课程信息", ico:"${ pageContext.request.contextPath}/images/icon_default.gif",link:"Teacher_coursequery.action?tid=${loginUserName}"},
	{ level:2, name:"成绩信息", ico:"${ pageContext.request.contextPath}/images/icon_default.gif",link:"Teacher_courselist.action?tid=${loginUserName}"},
];
</script>
<style>
* {
