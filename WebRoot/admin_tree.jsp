...
var treeMenu = [
	{ level:1, name:"用户管理"},
	{ level:2, name:"学生信息", ico:"${pageContext.request.contextPath}/images/icon_default.gif",link:"Admin_stuquery.action"},
	{ level:2, name:"教师信息", ico:"${pageContext.request.contextPath}/images/icon_default.gif",link:"Admin_teaquery.action"},
	{ level:1, name:"信息管理"},
	{ level:2, name:"教学信息", ico:"${pageContext.request.contextPath}/images/icon_default.gif",link:"admin/anno_add.jsp"},
	{ level:2, name:"招聘信息", ico:"${pageContext.request.contextPath}/images/icon_default.gif",link:"admin/recru_add.jsp"}, 
	{ level:2, name:"培养计划", ico:"${pageContext.request.contextPath}/images/icon_default.gif",link:"<%=path%>/Admin_collagelist.action"},
	{ level:2, name:"学院专业", ico:"${pageContext.request.contextPath}/images/icon_default.gif",link:"Admin_majorquery.action"},
];
</script>
<style>
* {
